...
기능을 확장해가며** Spring Security의 구조를 직접 구현해보는 실습형 학습 프로젝트입니다.

## 목차

각 단계는 독립적인 Git 브랜치로 나누어져 있어, 단계별로 차근차근 따라갈 수 있습니다.
...
| [step-3-authorization]                    | 권한 인가 로직 기본 구현         |
| [step-4-authorization-advanced]           | 다양한 인가 전략 적용           |
| [step-5-exception-translation-filter]     | 예외 처리 필터 구현            |
| [step-6-security-context-holder-filter]   | SecurityContext 저장 필터  |
| [step-7-filter-chain-proxy]               | FilterChainProxy 직접 구현 |
